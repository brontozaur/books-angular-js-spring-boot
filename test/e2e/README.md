...
A local fileserver can be accessed at `http://localhost:8000/`
App cannot be executed like this, since the back-end is not connected.
TODO: a demo html page for this fileserver.
